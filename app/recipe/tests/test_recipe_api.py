...
class PrivateRecipeAPITest(TestCase):
    ...
    def test_filter_by_tags(self):
        ...
        r1 = create_recipe(user=self.user, title='Thai Curry Vegetable')
        r2 = create_recipe(user=self.user, title='Chocolate cookies')
        ...
        # making the request with the params to filter data
    ...
    def test_filter_by_ingredients(self):
        ...
        r2 = create_recipe(user=self.user, title='Roasted Chicken')
        in1 = Ingredient.objects.create(user=self.user, name='Feta Cheese')
        in2 = Ingredient.objects.create(user=self.user, name='Chicken')
        r1.ingredients.add(in1)
        r2.ingredients.add(in2)
        r3 = create_recipe(user=self.user, title='Mack  and Cheese')
